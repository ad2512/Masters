...
model5 = Sequential()
model5.add(Convolution2D(8,2,2,init='uniform',border_mode='valid',input_shape=(1,28,28)))
model5.add(Activation('relu'))
model5.add(MaxPooling2D(pool_size=(2,2)))
model5.add(Convolution2D(16,2,2,init='uniform',border_mode='valid',input_shape=(1,28,28)))
model5.add(Activation('relu'))
model5.add(MaxPooling2D(pool_size=(2,2)))
model5.add(Convolution2D(32,2,2,init='uniform',border_mode='valid',input_shape=(1,28,28)))
model5.add(Activation('relu'))
model5.add(MaxPooling2D(pool_size=(2,2)))
model5.add(Flatten())
model4.add(Dropout(0.5))

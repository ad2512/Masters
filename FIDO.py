...
model.fit(train_data[0:np.shape(train_data)[0]], train_labels[0:np.shape(train_labels)[0]], batch_size=8, nb_epoch=1000,verbose=1,show_accuracy=True,validation_data=(test_data, test_labels))

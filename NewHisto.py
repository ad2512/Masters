...
# Setting up the Data
A=558;
l = float(genfromtxt("/home/silo1/ad2512/NewHisto/L" + str(1) + ".csv",delimiter=','))
l1 = float(genfromtxt("/home/silo1/ad2512/NewHisto/L" + str(2) + ".csv",delimiter=','))
d = cv2.imread('/home/silo1/ad2512/NewHisto/ZERONORM1.jpg')
d1 = cv2.imread('/home/silo1/ad2512/NewHisto/ZERONORM2.jpg')
all_data=[d,d1]
labels=[l,l1]
for i in range(A-2):
	if((i+3)>A):
		break
	l = float(genfromtxt("/home/silo1/ad2512/NewHisto/L" + str(i+3) + ".csv",delimiter=','))
	d = cv2.imread("/home/silo1/ad2512/NewHisto/ZERONORM" + str(i+3) + ".jpg")
	all_data.append(d)
	labels.append(l)
...
Ada = Adadelta(lr=0.003, rho=0.95, epsilon=1e-06)

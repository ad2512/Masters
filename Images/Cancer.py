...
model.add(Flatten())
#model.add(Dense(50))
m#odel.add(Activation('relu'))
m#odel.add(Dropout(0.5))
model.add(Dense(7))
model.add(Activation('softmax'))

model.compile(loss='categorical_crossentropy', optimizer="RMSprop")
model.fit(train, labels_1, batch_size=20, nb_epoch=5,verbose=1,show_accuracy=True,validation_data=(test, labels_2a))

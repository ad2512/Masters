...
model2.fit(train, labels_1, batch_size=200, nb_epoch=nb,verbose=1,show_accuracy=True,validation_data=(test, labels_2a))
...
model3.compile(loss='msle', optimizer='sgd')
...
model4.compile(loss='categorical_crossentropy', optimizer="adagrad")
...
model5.add(Convolution2D(24,3,3,init='uniform',border_mode='valid',input_shape=(1,28,28)))
model5.add(Activation('relu'))
model5.add(MaxPooling2D(pool_size=(2,2)))

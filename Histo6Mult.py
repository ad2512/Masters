...
l1 = float(genfromtxt("/home/silo1/ad2512/Histo_6/L" + str(1) + "b.csv",delimiter=','))
...
# Building Model
model = Sequential()
model.add(Convolution2D(6,3,3,init='uniform',border_mode='full',input_shape=(3,s,s)))
...
Ada = Adadelta(lr=0.001, rho=0.95, epsilon=1e-08)

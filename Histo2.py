...
Ada = Adadelta(lr=0.00003, rho=0.95, epsilon=1e-06)
model.compile(loss='categorical_crossentropy', optimizer=Ada)
model.fit(train_data, train_labels, batch_size=8, nb_epoch=500,verbose=1,show_accuracy=True,validation_data=(test_data, test_labels))
